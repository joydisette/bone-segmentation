...
if nohup:
    ...
    os.system(run_GPU +' nohup python -u ./src/pelvis_prediction.py > ' +'./'+name_experiment+'/'+name_experiment+'_prediction.nohup')
else:
    print "\n2. Run the prediction on GPU (no nohup)"
    os.system(run_GPU +' python ./src/pelvis_prediction.py')
