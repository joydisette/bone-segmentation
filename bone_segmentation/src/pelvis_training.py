...
patches_imgs_train, patches_masks_train = get_data_training(
    xrays_train_imgs_original = path_data + config.get('data paths', 'train_imgs_original'),
    xrays_train_groudTruth = path_data + config.get('data paths', 'train_groundTruth'),  #masks
