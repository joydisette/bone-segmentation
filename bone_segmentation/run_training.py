...
if nohup:
    ...
    os.system(run_GPU +' nohup python -u ./src/pelvis_training.py > ' +'./'+name_experiment+'/'+name_experiment+'_training.nohup')
else:
    print "\n2. Run the training on GPU (no nohup)"
    os.system(run_GPU +' python ./src/pelvis_training.py')
